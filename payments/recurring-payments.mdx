...
<AccordionGroup>
  ...
  <Accordion title="Authorized" icon="lock">
    Payment method has been authorized (pre-authorized) but funds not yet captured. Common with payment processor flows.

    **Next Step:** Capture funds when delivery ships or billing date arrives
  </Accordion>
