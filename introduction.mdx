...
<CardGroup cols={2}>
  ...
  <Card title="Dunning & Failed Payments" icon="exclamation-circle" href="/payments/dunning">
    Maximize revenue recovery through intelligent retry logic and customer communication
  </Card>
